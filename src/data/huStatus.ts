...
export const HU_STATUS: HuEntry[] = [
  ...
  { id: 'HU-04', title: 'Filtrar mascotas', role: 'adopter', route: '/buscar', done: false, phase: 1 },
  { id: 'HU-05', title: 'Mascotas cercanas', role: 'adopter', route: '/buscar', done: false, phase: 1 },
  ...
  { id: 'HU-09', title: 'Chat grupal por mascota', role: 'adopter', route: '/chats', done: false, phase: 1 },
  { id: 'HU-10', title: 'Coordinar adopción', role: 'adopter', route: '/coordinar/p01', done: true, phase: 0 },
  { id: 'HU-11', title: 'Registrar mascota', role: 'owner', route: '/responsable', done: false, phase: 2 },
  { id: 'HU-12', title: 'Editar información de mascota', role: 'owner', route: '/responsable', done: false, phase: 2 },
  { id: 'HU-13', title: 'Notificaciones de interés', role: 'owner', route: '/notificaciones', done: false, phase: 2 },
  { id: 'HU-14', title: 'Guía de adopción', role: 'any', route: '/perfil', done: false, phase: 1 },
  { id: 'HU-15', title: 'Recuperar contraseña', role: 'any', route: '/login', done: false, phase: 1 },
  { id: 'HU-16', title: 'Fotos y etiquetas', role: 'owner', route: '/responsable', done: false, phase: 2 },
  { id: 'HU-17', title: 'Favoritos', role: 'adopter', route: '/perfil', done: false, phase: 1 },
  { id: 'HU-18', title: 'Historial de interés', role: 'adopter', route: '/perfil', done: false, phase: 1 },
